  ...
  <div class="popup-content">
    ...
    <form enctype="multipart/form-data" @submit.prevent="submitOrder" id="edit-order-form">
        ...
        <div class="file-input">
          <label :for="`passport ${numberKey}`" class="file-upload-label">
            <div class="body-file">
              ...
              <span class="title-header">Please enter your passport at here</span>
            </div>
      ...
      <div class="form-col">
        ...
        <div class="row">
          <label for="departure_time">Order_Time</label>
  ...
  methods: {
    ...
    async submitOrder() {
      try {
        ...
        console.log("đây là operator_id", this.orderData.status_Operator_ID);
        console.log("data of orderDataa", this.orderData);

        await axios.post(`${apiUrl}/order/update/${this.orderId}`, this.orderData);
        this.success();
      ...
      axios
        ...
        .then((response) => {
          ...
          if (responseData) {
            ...
            console.log(
              "giá trị status operator",
              responseData.status_Opeartor
            );
            ...
            console.log(
              "đây là data của orderData",
              this.orderData.status_Operator_ID
            );
          }
        })
        .catch((error) => {
    ...
    saveAndNext() {
      this.part1Data = { ...this.orderData };
      this.currentPart = 2;
    },

    prevPart() {
      this.orderData = { ...this.part1Data };
      this.currentPart = 1;
    },
  },
};
