          ...
          <table>
            ...
            <tbody class="order-info">
              <tr v-for="item in items" :key="item.id" class="order-information">
                ...
                <td>
                  <div class="item" :data-id="item.id" id="status" :style="getStatusStyle(item.status)">
                    {{ item.status }}
                  </div>
                </td>
                <td>
                  <div class="item" :data-id="item.id" id="status" :style="getStatusStyle(item.status_Operator)">
                    {{ item.status }}
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="item" :data-id="item.id">{{ item.flight_Number }} </div>
                </td>
                <td>
                ...
                <td>
                  <span class="item" :data-id="item.id">{{ getEmployeeName(item.employee) }}</span>
                </td>
              </tr>
            </tbody>
          </table>
